  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        modern: "bg-gradient-primary text-white hover:shadow-modern-lg transition-all duration-300",
        success: "bg-gradient-success text-white hover:shadow-modern-lg transition-all duration-300",
        warning: "bg-gradient-warning text-white hover:shadow-modern-lg transition-all duration-300",
        error: "bg-gradient-error text-white hover:shadow-modern-lg transition-all duration-300",
      },
      size: {
